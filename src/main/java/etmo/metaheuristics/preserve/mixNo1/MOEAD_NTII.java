...
//                    }
                        ...
                        updateProblem(child, n, neiborType, taskId);
                    }
                    else{
                        int id = PseudoRandom.randInt(0, 7);
                        ...
                        if (id <=6){
                            ...
                            switch (id){
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    crossover = CrossoverFactory.getCrossoverOperator("TpCrossover", parameters); //Two point
                                    break;
                                case 2:
                                    crossover = CrossoverFactory.getCrossoverOperator("UfCrossover", parameters);//Uniform
                                    break;
                                case 3:
                                    crossover = CrossoverFactory.getCrossoverOperator("AriCrossover", parameters);//Arithmetical
                                    break;
                                case 4:
                                    crossover = CrossoverFactory.getCrossoverOperator("GeoCrossover", parameters);//Geometrical
                                    break;
                                case 5:
                                    crossover = CrossoverFactory.getCrossoverOperator("BLX03Crossover", parameters);//BLX-0.3
                                    break;
                                case 6:
